...
projects = 
    ...
    , Project { projectName = wsCTF
              , projectDirectory = "~/ctf"
              , projectStartHook = Just $ do spawnOn wsCTF myTerminal
                                             spawnOn wsCTF myTerminal
...
addSpace     = renamed [CutWordsLeft 2] . mySpacing
...
oneBig       = addTopBar
              ...
              $ myGaps
              $ OneBig (3/4) (3/4)
layouts      = bspL ||| tab ||| threeCol ||| oneBig
...
myBigFont   = "xft:Source Code Pro:size=9:bold:antialias=true"
...
--    where
--        scratchFranz = namedScratchPadAction  scratchpads "franz"
--        scratchSpotify = namedScratchPadAction  scratchpads "spotify"
  ++
